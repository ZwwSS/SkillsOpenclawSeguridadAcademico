...
model_upgrade_premium: deepseek/deepseek-r1  # opcional: usar el modelo de razonamiento en producción real para mejor juicio antes de tocar sistemas del cliente
